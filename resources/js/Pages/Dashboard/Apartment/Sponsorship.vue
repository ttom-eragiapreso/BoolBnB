...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div v-show="!showModal" class="py-6 mt-12 max-w-[76rem] mx-auto sm:px-6 lg:px-8 bg-white sm:rounded-xl my-4 text-center">

            <p class="font-semibold text-lg">Sponsor your apartments to increase their visibility, choose the best plan for you:</p>

            <div class="flex w-full gap-6 my-8 text-left">
