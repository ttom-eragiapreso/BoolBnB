...
export default {
    ...
    mounted(){
        ...
        map.on('load', ()=>{
            ...
            let marker = new tt.Marker().setLngLat([this.apartment.longitude, this.apartment.latitude]).setPopup(popup);
            marker.addTo(map);
        })
    }
}
...
<template>
    ...
    <div class="container">
        ...
        <p>{{ apartment.full_address }}, {{ apartment.city }}, {{ apartment.country }}</p>
